...
import INeedResources from '../Pages/INeedResources'
            ...
            <Router>
                <div className="card text-center">
                    <div className="card-body">
                        ...
                        <a href="#" className="btn btn-primary mx-1">Mental Health</a>
                        ...
                        <Route path="/" className="btn btn-primary mx-1" exact component={INeedResources}/>
                        <Route exact path='./Pages/INeedResources' component={INeedResources}></Route>
                    </div>
                </div>
            </Router>    
        </div>
